...
const InChargeComplaint = () => {
  ...
  const getInchargeComplaint = async () => {
    let token = localStorage.getItem("token");
    const data = await fetch(
      "http://localhost:4500/user/get_incharge_complaints",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  const updateStatus = async (id) => {
    ...
    console.log(status);
    const data = await fetch(
      "http://localhost:4500/user/update_status_by_id",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
                            ...
                            <form>
                                ...
                                <div className="row justify-content-center align-items-center mt-3">
                                  ...
                                  <div class="mb-3">
                                    ...
                                    >
                                      ...
                                      <option value="pa">Paused</option>
                                      <option value="ra">Raised to admin</option>
                                    </select>
                                  </div>
                                </div>
                              </div>
                              <div class="modal-footer">
                                ...
                                <button
                                  ...
                                  onClick={()=> { updateStatus(complaint.cid) }}
                                >
                                  Update
                                </button>
                              </div>
...
export default InChargeComplaint;
